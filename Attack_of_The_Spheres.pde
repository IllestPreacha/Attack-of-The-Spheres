...
String Commentary[] = {
    "Thank you for tryin out this demo", 
    "You are still using it, thanks", 
    "Random Feed 3", 
    "This could get boring after a while", 
    "Blank Statements Dont Count"
    };

/**
 * This method marks The X and Y coordinates of the mouse
 */
void coordinates()
{
  pushMatrix();
...
/**
 * This method creates an ellipse on the screen
 */
void ellipses()
{
  pushMatrix();
...
/**
 * This method draws an elipse by utilzing the height and width function alongside the dividing principles of the display
 */ 
void draw()
{
  lights();
